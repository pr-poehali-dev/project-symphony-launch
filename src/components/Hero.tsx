  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Здоровье,
          <span className="block text-sage">которое расцветает</span>
        </h1>
        ...
        >
          Встреча врача-гинеколога и инструктора по йоге. Узнайте, как гармония тела и движения влияет на женское здоровье, гормоны и качество жизни.
        </p>
