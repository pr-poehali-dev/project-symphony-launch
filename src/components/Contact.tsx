      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Всего 10 участниц. Оставьте заявку, и мы свяжемся с вами для подтверждения участия и деталей встречи.
            </p>
            ...
            >
              <div>
                ...
                <p className="text-foreground">Очная встреча в фитнес-студии</p>
              </div>
              <div>
