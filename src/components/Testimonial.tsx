  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я впервые поняла, почему в определённые дни цикла занятия йогой даются легко, а в другие — тело просит покоя. Эта встреча изменила моё отношение к себе.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Мария, 34 года</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Участница прошедшей встречи</p>
        </div>
      </div>
    </section>
  )
